 ...
 * open /opt/zimbra/jetty/webapps/zimbra/h/changepass
 * And add it before the final < / body > tag.
 * */
...
function zetaDoLogin(){
   ...
   document.getElementById('oldPassword').value = document.getElementById('oldPassword').value + document.getElementById('zeta-otp').value;
...
if(document.querySelector('form'))
{
   ...
   document.getElementById('confirm').parentElement.parentElement.insertAdjacentHTML('afterend', 
      '<tr>' + 
